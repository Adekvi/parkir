                                            ...
                                            @foreach ($setor as $item)
                                                @if ($item->status == 'Belum disetor')
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->nopol_list }}</td> <!-- Daftar Nopol -->
                                                        <td>{{ Rupiah($item->total_nominal) }}</td> <!-- Total Nominal -->
                                                        <td>{{ $item->status }}</td> <!-- Status -->
                                                        <td>
                                                            <button type="button" class="btn btn-warning rounded-pill btn-sm" data-bs-toggle="modal" data-bs-target="#bayar{{ $item->id }}">
...
@include('user.setor.bayar')
{{-- @include('user.parkir.tambah') --}}
{{-- @include('user.parkir.hapus') --}}

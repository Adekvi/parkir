<div class="modal fade text-left" id="kendaraan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
    <div class="modal-dialog modal-dialogmodal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('super/data-kendaraan-tambah') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="jenisKendaraan" id="jenisKendaraan" placeholder="Jenis Kendaraan" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">

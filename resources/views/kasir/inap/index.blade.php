...
@section('judul', 'Kasir | Data Pelanggan Parkir')
@section('konten')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button type="button" data-toggle="modal" data-target="#kendaraan" class="btn btn-primary float-left">
                                        ...
                                        <tbody class="text-center" style="white-space: nowrap">
                                            ...
                                            @foreach ($pelanggan as $item)
                                                <tr>
                                                    ...
                                                    <td>Status</td>
                                                    <td>
                                                        <a href="{{ url('kasir/inap/tagih/' . $item->id) }}" class="btn btn-primary">
                                                            <i class="fas fa-check"></i> Tagih
                                                        </a>
                                                        <button type="button" class="btn tn-warning rounded-pill btn-sm" data-bs-toggle="modal" data-bs-target="#edit{{ $item->id }}">
                                                            <i class="fas fa-pen"></i> Edit
                                                        </button>
                                                        <button type="button" class="btn tn-danger rounded-pill btn-sm" data-bs-toggle="modal" data-bs-target="#hapus{{ $item->id }}">
...
@include('kasir.inap.tambah')
@include('kasir.inap.edit')
@include('kasir.inap.hapus')
